...
This branch contains a modified version of the original code to fit Matko's scooter:
 - ADC is used as a speed setpoint
 - No steering: both wheels driven with the same setpoint
